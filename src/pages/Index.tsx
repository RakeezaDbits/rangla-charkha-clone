    ...
    <main>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl text-center text-foreground mb-12">New Arrivals</h2>
          {products.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground font-body">Products coming soon!</p>
          )}
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl text-center text-foreground mb-4">Why Choose Rangla Charkha?</h2>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 text-center space-y-6">
          <h2 className="font-display text-3xl md:text-4xl text-foreground">Latest Lawn Collection in Pakistan</h2>
